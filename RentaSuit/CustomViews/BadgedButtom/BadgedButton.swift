...
//  RentaSuit
//
//  Created by BACEM Ben Afia on 12/3/18.
...
class BadgedButton: UIButton {
        ...
        public var badgeBackgroundColor = UIColor.yellowApp() {
            didSet {
        ...
        func addBadgeToButon(badge: String?) {
            ...
            let height = max(12, Double(badgeSize.height) + 2.0)
